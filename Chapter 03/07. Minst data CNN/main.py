...
from sudoku import solve, verify
import numpy as np
import copy
import cv2
import math
...
if __name__ == "__main__":
    ...
    board, corners, img, warped_img = get_sudoku("07. Minst data CNN\images\sudoku.png", show_contours = False, 
    ...
    cv2.imwrite("sudoku_output.png", output)